...
- *前端技术*: React, HTML/CSS, Tailwind CSS, Vite构建工具
- *后端技术*: Node.js, Express, 文件处理, API设计
- *专业技能*: 算法设计, 数据结构, 计算机视觉, 机器学习, 音频信号处理
...
#resume-project(
  ...
  - 技术栈：React 18、TypeScript、Tailwind CSS、Express、文件上传、热重载
  - 功能特性：响应式设计、Markdown渲染、文档管理、音频集成、主题切换
]
